...
namespace GizmoFort.Connector.ERPNext.ERPTypes.Projects.ProjectUpdate
{
    ...
    {
        public ERP_Projects_ProjectUpdate() : this(new ERPObject(_DocType.Projects_ProjectUpdate)) { }
        ...
        [ColumnInfo("sent", "int(1)", isNullable: false)]
        public bool Sent
        {
            get { return ERPNextConverter.IntToBool((int)data.sent); }
            set { data.sent = ERPNextConverter.BoolToInt(value); }
        }
