...
namespace GizmoFort.Connector.ERPNext.ERPTypes.LoanManagement.SanctionedLoanAmount
{
    ...
    {
        public ERP_LoanManagement_SanctionedLoanAmount() : this(new ERPObject(_DocType.LoanManagement_SanctionedLoanAmount)) { }
        ...
        [ColumnInfo("sanctioned_amount_limit", "decimal(21,9)", isNullable: false)]
