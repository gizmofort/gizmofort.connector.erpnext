...
namespace GizmoFort.Connector.ERPNext.ERPTypes.LoanManagement.ProcessLoanInterestAccrual
{
    ...
    {
        public ERP_LoanManagement_ProcessLoanInterestAccrual() : this(new ERPObject(_DocType.LoanManagement_ProcessLoanInterestAccrual)) { }
        ...
        [ColumnInfo("process_type", "varchar(140)", isNullable: true)]
        public string? ProcessType
        {
            get { return data.process_type; }
            set { data.process_type = ERPNextConverter.TruncateString(value, 140); }
        }
