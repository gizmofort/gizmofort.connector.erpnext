...
namespace GizmoFort.Connector.ERPNext.ERPTypes.EventStreaming.EventProducerDocumentType
{
    ...
    {
        public static ERP_EventStreaming_EventProducerDocumentType CreateNew(string name /* add other parameters as needed */ )
        {
            ERP_EventStreaming_EventProducerDocumentType obj = new()
            {
                Name = name
