...
namespace GizmoFort.Connector.ERPNext.ERPTypes.Manufacturing.BlanketOrderItem
{
    ...
    {
        public ERP_Manufacturing_BlanketOrderItem() : this(new ERPObject(_DocType.Manufacturing_BlanketOrderItem)) { }
        ...
        [ColumnInfo("terms_and_conditions", "text", isNullable: true)]
