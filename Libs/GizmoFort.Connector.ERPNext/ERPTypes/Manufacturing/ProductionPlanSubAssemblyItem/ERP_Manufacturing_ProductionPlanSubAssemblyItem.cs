...
namespace GizmoFort.Connector.ERPNext.ERPTypes.Manufacturing.ProductionPlanSubAssemblyItem
{
    ...
    {
        public static ERP_Manufacturing_ProductionPlanSubAssemblyItem CreateNew(string name /* add other parameters as needed */ )
        {
            ERP_Manufacturing_ProductionPlanSubAssemblyItem obj = new()
            {
                Name = name
