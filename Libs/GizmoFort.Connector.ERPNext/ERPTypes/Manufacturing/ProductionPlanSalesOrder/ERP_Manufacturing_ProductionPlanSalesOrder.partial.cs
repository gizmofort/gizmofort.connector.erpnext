...
namespace GizmoFort.Connector.ERPNext.ERPTypes.Manufacturing.ProductionPlanSalesOrder
{
    ...
    {
        public ERP_Manufacturing_ProductionPlanSalesOrder() : this(new ERPObject(_DocType.Manufacturing_ProductionPlanSalesOrder)) { }
        ...
        [ColumnInfo("sales_order_date", "date", isNullable: true)]
        public DateOnly? SalesOrderDate
        {
            get { return ERPNextConverter.StringToDateOnly(data.sales_order_date); }
            set { data.sales_order_date = ERPNextConverter.DateOnlyToString(value); }
        }
