...
namespace GizmoFort.Connector.ERPNext.ERPTypes.Manufacturing.ProductionPlanSalesOrder
{
    ...
    {
        public static ERP_Manufacturing_ProductionPlanSalesOrder CreateNew(string name /* add other parameters as needed */ )
        {
            ERP_Manufacturing_ProductionPlanSalesOrder obj = new()
            {
                Name = name
