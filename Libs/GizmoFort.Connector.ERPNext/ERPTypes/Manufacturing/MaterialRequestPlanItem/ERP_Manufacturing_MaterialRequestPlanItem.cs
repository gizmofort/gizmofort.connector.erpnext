...
namespace GizmoFort.Connector.ERPNext.ERPTypes.Manufacturing.MaterialRequestPlanItem
{
    ...
    {
        public static ERP_Manufacturing_MaterialRequestPlanItem CreateNew(string name /* add other parameters as needed */ )
        {
            ERP_Manufacturing_MaterialRequestPlanItem obj = new()
            {
                Name = name
