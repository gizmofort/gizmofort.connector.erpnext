...
namespace GizmoFort.Connector.ERPNext.ERPTypes.Telephony.IncomingCallHandlingSchedule
{
    ...
    {
        public ERP_Telephony_IncomingCallHandlingSchedule() : this(new ERPObject(_DocType.Telephony_IncomingCallHandlingSchedule)) { }
        ...
        [ColumnInfo("agent_group", "varchar(140)", isNullable: true)]
        public string? AgentGroup
        {
            get { return data.agent_group; }
            set { data.agent_group = ERPNextConverter.TruncateString(value, 140); }
        }
