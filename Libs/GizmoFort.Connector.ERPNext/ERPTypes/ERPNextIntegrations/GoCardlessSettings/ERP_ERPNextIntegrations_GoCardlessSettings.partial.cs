...
namespace GizmoFort.Connector.ERPNext.ERPTypes.ERPNextIntegrations.GoCardlessSettings
{
    ...
    {
        public ERP_ERPNextIntegrations_GoCardlessSettings() : this(new ERPObject(_DocType.ERPNextIntegrations_GoCardlessSettings)) { }
        ...
        [ColumnInfo("webhooks_secret", "varchar(140)", isNullable: true)]
        public string? WebhooksSecret
        {
            get { return data.webhooks_secret; }
            set { data.webhooks_secret = ERPNextConverter.TruncateString(value, 140); }
        }
