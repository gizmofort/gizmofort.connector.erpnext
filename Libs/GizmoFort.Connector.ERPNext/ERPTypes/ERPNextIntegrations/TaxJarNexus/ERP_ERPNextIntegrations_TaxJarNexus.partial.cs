...
namespace GizmoFort.Connector.ERPNext.ERPTypes.ERPNextIntegrations.TaxJarNexus
{
    ...
    {
        public ERP_ERPNextIntegrations_TaxJarNexus() : this(new ERPObject(_DocType.ERPNextIntegrations_TaxJarNexus)) { }
        ...
        [ColumnInfo("region", "varchar(140)", isNullable: true)]
        public string? Region
        {
            get { return data.region; }
            set { data.region = ERPNextConverter.TruncateString(value, 140); }
        }

        [ColumnInfo("region_code", "varchar(140)", isNullable: true)]
        public string? RegionCode
        {
            get { return data.region_code; }
            set { data.region_code = ERPNextConverter.TruncateString(value, 140); }
        }
        ...
        [ColumnInfo("country_code", "varchar(140)", isNullable: true)]
        public string? CountryCode
        {
            get { return data.country_code; }
            set { data.country_code = ERPNextConverter.TruncateString(value, 140); }
        }
