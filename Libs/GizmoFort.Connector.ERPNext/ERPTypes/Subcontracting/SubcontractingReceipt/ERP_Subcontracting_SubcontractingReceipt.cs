...
namespace GizmoFort.Connector.ERPNext.ERPTypes.Subcontracting.SubcontractingReceipt
{
    ...
    {
        public static ERP_Subcontracting_SubcontractingReceipt CreateNew(string name /* add other parameters as needed */ )
        {
            ERP_Subcontracting_SubcontractingReceipt obj = new()
            {
                Name = name
