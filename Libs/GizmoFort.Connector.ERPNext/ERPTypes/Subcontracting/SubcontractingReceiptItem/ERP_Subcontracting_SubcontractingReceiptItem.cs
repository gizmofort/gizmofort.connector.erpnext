...
namespace GizmoFort.Connector.ERPNext.ERPTypes.Subcontracting.SubcontractingReceiptItem
{
    ...
    {
        public static ERP_Subcontracting_SubcontractingReceiptItem CreateNew(string name /* add other parameters as needed */ )
        {
            ERP_Subcontracting_SubcontractingReceiptItem obj = new()
            {
                Name = name
