...
namespace GizmoFort.Connector.ERPNext.ERPTypes.Subcontracting.SubcontractingOrderItem
{
    ...
    {
        public static ERP_Subcontracting_SubcontractingOrderItem CreateNew(string name /* add other parameters as needed */ )
        {
            ERP_Subcontracting_SubcontractingOrderItem obj = new()
            {
                Name = name
