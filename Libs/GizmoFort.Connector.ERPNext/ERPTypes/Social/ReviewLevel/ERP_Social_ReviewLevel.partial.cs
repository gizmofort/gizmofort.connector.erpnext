...
namespace GizmoFort.Connector.ERPNext.ERPTypes.Social.ReviewLevel
{
    ...
    {
        public ERP_Social_ReviewLevel() : this(new ERPObject(_DocType.Social_ReviewLevel)) { }
        ...
        [ColumnInfo("level_name", "varchar(140)", isNullable: true)]
        public string? LevelName
        {
            get { return data.level_name; }
            set { data.level_name = ERPNextConverter.TruncateString(value, 140); }
        }
        ...
        [ColumnInfo("review_points", "int(11)", isNullable: false)]
