...
namespace GizmoFort.Connector.ERPNext.ERPTypes.QualityManagement.QualityActionResolution
{
    ...
    {
        public ERP_QualityManagement_QualityActionResolution() : this(new ERPObject(_DocType.QualityManagement_QualityActionResolution)) { }
        ...
        [ColumnInfo("problem", "longtext", isNullable: true)]
        ...
        [ColumnInfo("resolution", "longtext", isNullable: true)]
        ...
        [ColumnInfo("responsible", "varchar(140)", isNullable: true)]
        public string? Responsible
        {
            get { return data.responsible; }
            set { data.responsible = ERPNextConverter.TruncateString(value, 140); }
        }

        [ColumnInfo("completion_by", "date", isNullable: true)]
        public DateOnly? CompletionBy
        {
            get { return ERPNextConverter.StringToDateOnly(data.completion_by); }
            set { data.completion_by = ERPNextConverter.DateOnlyToString(value); }
        }
