...
namespace GizmoFort.Connector.ERPNext.ERPTypes.QualityManagement.QualityActionResolution
{
    ...
    {
        public static ERP_QualityManagement_QualityActionResolution CreateNew(string name /* add other parameters as needed */ )
        {
            ERP_QualityManagement_QualityActionResolution obj = new()
            {
                Name = name
