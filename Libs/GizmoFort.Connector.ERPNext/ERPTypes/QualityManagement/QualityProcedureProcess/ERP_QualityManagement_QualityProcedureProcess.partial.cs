...
namespace GizmoFort.Connector.ERPNext.ERPTypes.QualityManagement.QualityProcedureProcess
{
    ...
    {
        public ERP_QualityManagement_QualityProcedureProcess() : this(new ERPObject(_DocType.QualityManagement_QualityProcedureProcess)) { }
        ...
        [ColumnInfo("process_description", "longtext", isNullable: true)]
