...
namespace GizmoFort.Connector.ERPNext.ERPTypes.QualityManagement.QualityMeetingMinutes
{
    ...
    {
        public ERP_QualityManagement_QualityMeetingMinutes() : this(new ERPObject(_DocType.QualityManagement_QualityMeetingMinutes)) { }
        ...
        [ColumnInfo("minute", "longtext", isNullable: true)]
