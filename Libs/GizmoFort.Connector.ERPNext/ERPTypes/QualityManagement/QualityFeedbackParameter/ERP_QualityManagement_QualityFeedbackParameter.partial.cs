...
namespace GizmoFort.Connector.ERPNext.ERPTypes.QualityManagement.QualityFeedbackParameter
{
    ...
    {
        public ERP_QualityManagement_QualityFeedbackParameter() : this(new ERPObject(_DocType.QualityManagement_QualityFeedbackParameter)) { }
        ...
        [ColumnInfo("rating", "varchar(140)", isNullable: true)]
        public string? Rating
        {
            get { return data.rating; }
            set { data.rating = ERPNextConverter.TruncateString(value, 140); }
        }

        [ColumnInfo("feedback", "longtext", isNullable: true)]
