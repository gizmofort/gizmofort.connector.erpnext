...
namespace GizmoFort.Connector.ERPNext.ERPTypes.QualityManagement.QualityFeedbackParameter
{
    ...
    {
        public static ERP_QualityManagement_QualityFeedbackParameter CreateNew(string name /* add other parameters as needed */ )
        {
            ERP_QualityManagement_QualityFeedbackParameter obj = new()
            {
                Name = name
