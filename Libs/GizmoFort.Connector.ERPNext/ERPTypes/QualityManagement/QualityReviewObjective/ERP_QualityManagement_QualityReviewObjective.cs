...
namespace GizmoFort.Connector.ERPNext.ERPTypes.QualityManagement.QualityReviewObjective
{
    ...
    {
        public static ERP_QualityManagement_QualityReviewObjective CreateNew(string name /* add other parameters as needed */ )
        {
            ERP_QualityManagement_QualityReviewObjective obj = new()
            {
                Name = name
