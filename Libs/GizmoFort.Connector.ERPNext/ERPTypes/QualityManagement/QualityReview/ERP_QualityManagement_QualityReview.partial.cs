...
namespace GizmoFort.Connector.ERPNext.ERPTypes.QualityManagement.QualityReview
{
    ...
    {
        public ERP_QualityManagement_QualityReview() : this(new ERPObject(_DocType.QualityManagement_QualityReview)) { }
        ...
        [ColumnInfo("additional_information", "text", isNullable: true)]
