...
namespace GizmoFort.Connector.ERPNext.ERPTypes.Assets.AssetMovementItem
{
    ...
    {
        public ERP_Assets_AssetMovementItem() : this(new ERPObject(_DocType.Assets_AssetMovementItem)) { }
        ...
        [ColumnInfo("source_location", "varchar(140)", isNullable: true)]
        public string? SourceLocation
        {
            get { return data.source_location; }
            set { data.source_location = ERPNextConverter.TruncateString(value, 140); }
        }

        [ColumnInfo("from_employee", "varchar(140)", isNullable: true)]
        public string? FromEmployee
        {
            get { return data.from_employee; }
            set { data.from_employee = ERPNextConverter.TruncateString(value, 140); }
        }
        ...
        [ColumnInfo("target_location", "varchar(140)", isNullable: true)]
        public string? TargetLocation
        {
            get { return data.target_location; }
            set { data.target_location = ERPNextConverter.TruncateString(value, 140); }
        }

        [ColumnInfo("to_employee", "varchar(140)", isNullable: true)]
        public string? ToEmployee
        {
            get { return data.to_employee; }
            set { data.to_employee = ERPNextConverter.TruncateString(value, 140); }
        }
