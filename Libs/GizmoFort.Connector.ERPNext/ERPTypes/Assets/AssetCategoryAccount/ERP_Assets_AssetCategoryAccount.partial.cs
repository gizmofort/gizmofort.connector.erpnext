...
namespace GizmoFort.Connector.ERPNext.ERPTypes.Assets.AssetCategoryAccount
{
    ...
    {
        public ERP_Assets_AssetCategoryAccount() : this(new ERPObject(_DocType.Assets_AssetCategoryAccount)) { }
        ...
        [ColumnInfo("fixed_asset_account", "varchar(140)", isNullable: true)]
        public string? FixedAssetAccount
        {
            get { return data.fixed_asset_account; }
            set { data.fixed_asset_account = ERPNextConverter.TruncateString(value, 140); }
        }
