...
namespace GizmoFort.Connector.ERPNext.ERPTypes.Assets.AssetMovement
{
    ...
    {
        public ERP_Assets_AssetMovement() : this(new ERPObject(_DocType.Assets_AssetMovement)) { }
        ...
        [ColumnInfo("transaction_date", "datetime(6)", isNullable: true)]
        public DateTimeOffset? TransactionDate
        {
            get { return ERPNextConverter.StringToDateTimeOffset(data.transaction_date); }
            set { data.transaction_date = ERPNextConverter.DateTimeOffsetToString(value, 6); }
        }
