...
namespace GizmoFort.Connector.ERPNext.ERPTypes.Website.PersonalDataDeletionStep
{
    ...
    {
        public ERP_Website_PersonalDataDeletionStep() : this(new ERPObject(_DocType.Website_PersonalDataDeletionStep)) { }
        ...
        [ColumnInfo("@partial", "int(1)", isNullable: false)]
        public bool Partial
        {
            get { return ERPNextConverter.IntToBool((int)data.@partial); }
            set { data.@partial = ERPNextConverter.BoolToInt(value); }
        }

        [ColumnInfo("fields", "text", isNullable: true)]
        ...
        [ColumnInfo("filtered_by", "varchar(140)", isNullable: true)]
        public string? FilteredBy
        {
            get { return data.filtered_by; }
            set { data.filtered_by = ERPNextConverter.TruncateString(value, 140); }
        }
