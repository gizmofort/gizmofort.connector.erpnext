...
namespace GizmoFort.Connector.ERPNext.ERPTypes.Automation.AutoRepeat
{
    ...
    {
        public ERP_Automation_AutoRepeat() : this(new ERPObject(_DocType.Automation_AutoRepeat)) { }
        ...
        [ColumnInfo("submit_on_creation", "int(1)", isNullable: false)]
        public bool SubmitOnCreation
        {
            get { return ERPNextConverter.IntToBool((int)data.submit_on_creation); }
            set { data.submit_on_creation = ERPNextConverter.BoolToInt(value); }
        }
        ...
        [ColumnInfo("repeat_on_day", "int(11)", isNullable: false)]
        ...
        [ColumnInfo("repeat_on_last_day", "int(1)", isNullable: false)]
        public bool RepeatOnLastDay
        {
            get { return ERPNextConverter.IntToBool((int)data.repeat_on_last_day); }
            set { data.repeat_on_last_day = ERPNextConverter.BoolToInt(value); }
        }

        [ColumnInfo("next_schedule_date", "date", isNullable: true)]
        public DateOnly? NextScheduleDate
        {
            get { return ERPNextConverter.StringToDateOnly(data.next_schedule_date); }
            set { data.next_schedule_date = ERPNextConverter.DateOnlyToString(value); }
        }
        ...
        [ColumnInfo("recipients", "text", isNullable: true)]
        ...
        [ColumnInfo("template", "varchar(140)", isNullable: true)]
        public string? Template
        {
            get { return data.template; }
            set { data.template = ERPNextConverter.TruncateString(value, 140); }
        }
