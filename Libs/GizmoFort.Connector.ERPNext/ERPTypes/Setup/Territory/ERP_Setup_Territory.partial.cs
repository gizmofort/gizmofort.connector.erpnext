...
namespace GizmoFort.Connector.ERPNext.ERPTypes.Setup.Territory
{
    ...
    {
        public ERP_Setup_Territory() : this(new ERPObject(_DocType.Setup_Territory)) { }
        ...
        [ColumnInfo("territory_name", "varchar(140)", isNullable: true)]
        public string? TerritoryName
        {
            get { return data.territory_name; }
            set { data.territory_name = ERPNextConverter.TruncateString(value, 140); }
        }

        [ColumnInfo("parent_territory", "varchar(140)", isNullable: true)]
        public string? ParentTerritory
        {
            get { return data.parent_territory; }
            set { data.parent_territory = ERPNextConverter.TruncateString(value, 140); }
        }
        ...
        [ColumnInfo("territory_manager", "varchar(140)", isNullable: true)]
        public string? TerritoryManager
        {
            get { return data.territory_manager; }
            set { data.territory_manager = ERPNextConverter.TruncateString(value, 140); }
        }
