...
namespace GizmoFort.Connector.ERPNext.ERPTypes.Setup.DrivingLicenseCategory
{
    ...
    {
        public ERP_Setup_DrivingLicenseCategory() : this(new ERPObject(_DocType.Setup_DrivingLicenseCategory)) { }
        ...
        [ColumnInfo("@class", "varchar(140)", isNullable: true)]
        public string? Class
        {
            get { return data.@class; }
            set { data.@class = ERPNextConverter.TruncateString(value, 140); }
        }
