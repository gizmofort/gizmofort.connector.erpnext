...
namespace GizmoFort.Connector.ERPNext.ERPTypes.Setup.Holiday
{
    ...
    {
        public ERP_Setup_Holiday() : this(new ERPObject(_DocType.Setup_Holiday)) { }
        ...
        [ColumnInfo("holiday_date", "date", isNullable: true)]
        public DateOnly? HolidayDate
        {
            get { return ERPNextConverter.StringToDateOnly(data.holiday_date); }
            set { data.holiday_date = ERPNextConverter.DateOnlyToString(value); }
        }

        [ColumnInfo("weekly_off", "int(1)", isNullable: false)]
        public bool WeeklyOff
        {
            get { return ERPNextConverter.IntToBool((int)data.weekly_off); }
            set { data.weekly_off = ERPNextConverter.BoolToInt(value); }
        }
