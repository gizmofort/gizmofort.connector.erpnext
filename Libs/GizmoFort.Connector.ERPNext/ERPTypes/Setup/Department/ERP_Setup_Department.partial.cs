...
namespace GizmoFort.Connector.ERPNext.ERPTypes.Setup.Department
{
    ...
    {
        public ERP_Setup_Department() : this(new ERPObject(_DocType.Setup_Department)) { }
        ...
        [ColumnInfo("department_name", "varchar(140)", isNullable: true)]
        public string? DepartmentName
        {
            get { return data.department_name; }
            set { data.department_name = ERPNextConverter.TruncateString(value, 140); }
        }

        [ColumnInfo("parent_department", "varchar(140)", isNullable: true)]
        public string? ParentDepartment
        {
            get { return data.parent_department; }
            set { data.parent_department = ERPNextConverter.TruncateString(value, 140); }
        }
