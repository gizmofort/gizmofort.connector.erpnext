...
namespace GizmoFort.Connector.ERPNext.ERPTypes.Ecommerce.WebsiteOffer
{
    ...
    {
        public ERP_Ecommerce_WebsiteOffer() : this(new ERPObject(_DocType.Ecommerce_WebsiteOffer)) { }
        ...
        [ColumnInfo("offer_title", "varchar(140)", isNullable: true)]
        public string? OfferTitle
        {
            get { return data.offer_title; }
            set { data.offer_title = ERPNextConverter.TruncateString(value, 140); }
        }

        [ColumnInfo("offer_subtitle", "varchar(140)", isNullable: true)]
        public string? OfferSubtitle
        {
            get { return data.offer_subtitle; }
            set { data.offer_subtitle = ERPNextConverter.TruncateString(value, 140); }
        }

        [ColumnInfo("offer_details", "longtext", isNullable: true)]
