...
namespace GizmoFort.Connector.ERPNext.ERPTypes.Integrations.OAuthAuthorizationCode
{
    ...
    {
        public static ERP_Integrations_OAuthAuthorizationCode CreateNew(string name /* add other parameters as needed */ )
        {
            ERP_Integrations_OAuthAuthorizationCode obj = new()
            {
                Name = name
