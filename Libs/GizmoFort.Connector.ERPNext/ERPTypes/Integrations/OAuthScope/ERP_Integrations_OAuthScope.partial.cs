...
namespace GizmoFort.Connector.ERPNext.ERPTypes.Integrations.OAuthScope
{
    ...
    {
        public ERP_Integrations_OAuthScope() : this(new ERPObject(_DocType.Integrations_OAuthScope)) { }
        ...
        [ColumnInfo("scope", "varchar(140)", isNullable: true)]
        public string? Scope
        {
            get { return data.scope; }
            set { data.scope = ERPNextConverter.TruncateString(value, 140); }
        }
