...
namespace GizmoFort.Connector.ERPNext.ERPTypes.Integrations.LDAPGroupMapping
{
    ...
    {
        public ERP_Integrations_LDAPGroupMapping() : this(new ERPObject(_DocType.Integrations_LDAPGroupMapping)) { }
        ...
        [ColumnInfo("ldap_group", "varchar(140)", isNullable: true)]
        public string? LdapGroup
        {
            get { return data.ldap_group; }
            set { data.ldap_group = ERPNextConverter.TruncateString(value, 140); }
        }

        [ColumnInfo("erpnext_role", "varchar(140)", isNullable: true)]
        public string? ErpnextRole
        {
            get { return data.erpnext_role; }
            set { data.erpnext_role = ERPNextConverter.TruncateString(value, 140); }
        }
