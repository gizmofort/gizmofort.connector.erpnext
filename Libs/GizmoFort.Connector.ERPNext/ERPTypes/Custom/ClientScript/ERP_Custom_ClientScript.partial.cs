...
namespace GizmoFort.Connector.ERPNext.ERPTypes.Custom.ClientScript
{
    ...
    {
        public ERP_Custom_ClientScript() : this(new ERPObject(_DocType.Custom_ClientScript)) { }
        ...
        [ColumnInfo("view", "varchar(140)", isNullable: true)]
        public string? View
        {
            get { return data.view; }
            set { data.view = ERPNextConverter.TruncateString(value, 140); }
        }
