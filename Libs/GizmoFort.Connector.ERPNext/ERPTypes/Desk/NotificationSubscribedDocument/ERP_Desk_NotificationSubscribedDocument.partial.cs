...
namespace GizmoFort.Connector.ERPNext.ERPTypes.Desk.NotificationSubscribedDocument
{
    ...
    {
        public ERP_Desk_NotificationSubscribedDocument() : this(new ERPObject(_DocType.Desk_NotificationSubscribedDocument)) { }
        ...
        [ColumnInfo("document", "varchar(140)", isNullable: true)]
        public string? Document
        {
            get { return data.document; }
            set { data.document = ERPNextConverter.TruncateString(value, 140); }
        }
