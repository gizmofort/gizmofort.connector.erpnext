...
namespace GizmoFort.Connector.ERPNext.ERPTypes.Desk.TagLink
{
    ...
    {
        public ERP_Desk_TagLink() : this(new ERPObject(_DocType.Desk_TagLink)) { }
        ...
        [ColumnInfo("tag", "varchar(140)", isNullable: true)]
        public string? Tag
        {
            get { return data.tag; }
            set { data.tag = ERPNextConverter.TruncateString(value, 140); }
        }
