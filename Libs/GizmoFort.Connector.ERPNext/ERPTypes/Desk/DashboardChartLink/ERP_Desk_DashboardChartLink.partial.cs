...
namespace GizmoFort.Connector.ERPNext.ERPTypes.Desk.DashboardChartLink
{
    ...
    {
        public ERP_Desk_DashboardChartLink() : this(new ERPObject(_DocType.Desk_DashboardChartLink)) { }
        ...
        [ColumnInfo("chart", "varchar(140)", isNullable: true)]
        public string? Chart
        {
            get { return data.chart; }
            set { data.chart = ERPNextConverter.TruncateString(value, 140); }
        }
