...
namespace GizmoFort.Connector.ERPNext.ERPTypes.Desk.WorkspaceShortcut
{
    ...
    {
        public ERP_Desk_WorkspaceShortcut() : this(new ERPObject(_DocType.Desk_WorkspaceShortcut)) { }
        ...
        [ColumnInfo("doc_view", "varchar(140)", isNullable: true)]
        public string? DocView
        {
            get { return data.doc_view; }
            set { data.doc_view = ERPNextConverter.TruncateString(value, 140); }
        }
        ...
        [ColumnInfo("stats_filter", "longtext", isNullable: true)]
