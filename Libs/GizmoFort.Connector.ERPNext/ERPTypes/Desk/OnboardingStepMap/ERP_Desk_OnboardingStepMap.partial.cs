...
namespace GizmoFort.Connector.ERPNext.ERPTypes.Desk.OnboardingStepMap
{
    ...
    {
        public ERP_Desk_OnboardingStepMap() : this(new ERPObject(_DocType.Desk_OnboardingStepMap)) { }
        ...
        [ColumnInfo("step", "varchar(140)", isNullable: true)]
        public string? Step
        {
            get { return data.step; }
            set { data.step = ERPNextConverter.TruncateString(value, 140); }
        }
