...
namespace GizmoFort.Connector.ERPNext.ERPTypes.Accounts.ExchangeRateRevaluation
{
    ...
    {
        public ERP_Accounts_ExchangeRateRevaluation() : this(new ERPObject(_DocType.Accounts_ExchangeRateRevaluation)) { }
        ...
        [ColumnInfo("total_gain_loss", "decimal(21,9)", isNullable: false)]
