...
namespace GizmoFort.Connector.ERPNext.ERPTypes.Accounts.PaymentReconciliationInvoice
{
    ...
    {
        public ERP_Accounts_PaymentReconciliationInvoice() : this(new ERPObject(_DocType.Accounts_PaymentReconciliationInvoice)) { }
        ...
        [ColumnInfo("invoice_date", "date", isNullable: true)]
        public DateOnly? InvoiceDate
        {
            get { return ERPNextConverter.StringToDateOnly(data.invoice_date); }
            set { data.invoice_date = ERPNextConverter.DateOnlyToString(value); }
        }
