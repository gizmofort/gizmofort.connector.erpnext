...
namespace GizmoFort.Connector.ERPNext.ERPTypes.Accounts.PaymentReconciliationInvoice
{
    ...
    {
        public static ERP_Accounts_PaymentReconciliationInvoice CreateNew(string name /* add other parameters as needed */ )
        {
            ERP_Accounts_PaymentReconciliationInvoice obj = new()
            {
                Name = name
