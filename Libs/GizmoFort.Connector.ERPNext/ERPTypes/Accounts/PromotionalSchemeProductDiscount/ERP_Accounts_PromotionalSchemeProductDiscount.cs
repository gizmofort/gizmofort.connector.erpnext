...
namespace GizmoFort.Connector.ERPNext.ERPTypes.Accounts.PromotionalSchemeProductDiscount
{
    ...
    {
        public static ERP_Accounts_PromotionalSchemeProductDiscount CreateNew(string name /* add other parameters as needed */ )
        {
            ERP_Accounts_PromotionalSchemeProductDiscount obj = new()
            {
                Name = name
