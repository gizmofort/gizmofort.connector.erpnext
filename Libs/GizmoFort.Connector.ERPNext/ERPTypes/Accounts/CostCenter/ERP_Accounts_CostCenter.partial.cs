...
namespace GizmoFort.Connector.ERPNext.ERPTypes.Accounts.CostCenter
{
    ...
    {
        public ERP_Accounts_CostCenter() : this(new ERPObject(_DocType.Accounts_CostCenter)) { }
        ...
        [ColumnInfo("cost_center_name", "varchar(140)", isNullable: true)]
        public string? CostCenterName
        {
            get { return data.cost_center_name; }
            set { data.cost_center_name = ERPNextConverter.TruncateString(value, 140); }
        }

        [ColumnInfo("cost_center_number", "varchar(140)", isNullable: true)]
        public string? CostCenterNumber
        {
            get { return data.cost_center_number; }
            set { data.cost_center_number = ERPNextConverter.TruncateString(value, 140); }
        }

        [ColumnInfo("parent_cost_center", "varchar(140)", isNullable: true)]
        public string? ParentCostCenter
        {
            get { return data.parent_cost_center; }
            set { data.parent_cost_center = ERPNextConverter.TruncateString(value, 140); }
        }
