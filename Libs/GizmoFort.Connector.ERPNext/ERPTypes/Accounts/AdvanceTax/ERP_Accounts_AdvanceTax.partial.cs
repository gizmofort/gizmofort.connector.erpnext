...
namespace GizmoFort.Connector.ERPNext.ERPTypes.Accounts.AdvanceTax
{
    ...
    {
        public ERP_Accounts_AdvanceTax() : this(new ERPObject(_DocType.Accounts_AdvanceTax)) { }
        ...
        [ColumnInfo("reference_detail", "varchar(140)", isNullable: true)]
        public string? ReferenceDetail
        {
            get { return data.reference_detail; }
            set { data.reference_detail = ERPNextConverter.TruncateString(value, 140); }
        }
