...
namespace GizmoFort.Connector.ERPNext.ERPTypes.Accounts.SalesTaxesandCharges
{
    ...
    {
        public ERP_Accounts_SalesTaxesandCharges() : this(new ERPObject(_DocType.Accounts_SalesTaxesandCharges)) { }
        ...
        [ColumnInfo("dont_recompute_tax", "int(1)", isNullable: false)]
        public bool DontRecomputeTax
        {
            get { return ERPNextConverter.IntToBool((int)data.dont_recompute_tax); }
            set { data.dont_recompute_tax = ERPNextConverter.BoolToInt(value); }
        }
