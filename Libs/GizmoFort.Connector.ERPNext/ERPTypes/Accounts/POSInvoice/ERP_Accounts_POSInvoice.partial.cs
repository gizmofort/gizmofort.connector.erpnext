...
namespace GizmoFort.Connector.ERPNext.ERPTypes.Accounts.POSInvoice
{
    ...
    {
        public ERP_Accounts_POSInvoice() : this(new ERPObject(_DocType.Accounts_POSInvoice)) { }
        ...
        [ColumnInfo("base_in_words", "varchar(140)", isNullable: true)]
        public string? BaseInWords
        {
            get { return data.base_in_words; }
            set { data.base_in_words = ERPNextConverter.TruncateString(value, 140); }
        }
        ...
        [ColumnInfo("in_words", "varchar(140)", isNullable: true)]
        public string? InWords
        {
            get { return data.in_words; }
            set { data.in_words = ERPNextConverter.TruncateString(value, 140); }
        }
