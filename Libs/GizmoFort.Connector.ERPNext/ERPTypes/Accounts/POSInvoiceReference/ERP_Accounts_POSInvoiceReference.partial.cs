...
namespace GizmoFort.Connector.ERPNext.ERPTypes.Accounts.POSInvoiceReference
{
    ...
    {
        public ERP_Accounts_POSInvoiceReference() : this(new ERPObject(_DocType.Accounts_POSInvoiceReference)) { }
        ...
        [ColumnInfo("pos_invoice", "varchar(140)", isNullable: true)]
        public string? PosInvoice
        {
            get { return data.pos_invoice; }
            set { data.pos_invoice = ERPNextConverter.TruncateString(value, 140); }
        }
