...
namespace GizmoFort.Connector.ERPNext.ERPTypes.Accounts.PromotionalSchemePriceDiscount
{
    ...
    {
        public static ERP_Accounts_PromotionalSchemePriceDiscount CreateNew(string name /* add other parameters as needed */ )
        {
            ERP_Accounts_PromotionalSchemePriceDiscount obj = new()
            {
                Name = name
