...
namespace GizmoFort.Connector.ERPNext.ERPTypes.Accounts.PaymentReconciliationPayment
{
    ...
    {
        public static ERP_Accounts_PaymentReconciliationPayment CreateNew(string name /* add other parameters as needed */ )
        {
            ERP_Accounts_PaymentReconciliationPayment obj = new()
            {
                Name = name
