...
namespace GizmoFort.Connector.ERPNext.ERPTypes.Accounts.PaymentTermsTemplateDetail
{
    ...
    {
        public static ERP_Accounts_PaymentTermsTemplateDetail CreateNew(string name /* add other parameters as needed */ )
        {
            ERP_Accounts_PaymentTermsTemplateDetail obj = new()
            {
                Name = name
