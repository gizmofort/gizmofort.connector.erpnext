...
namespace GizmoFort.Connector.ERPNext.ERPTypes.Accounts.SalesInvoicePayment
{
    ...
    {
        public ERP_Accounts_SalesInvoicePayment() : this(new ERPObject(_DocType.Accounts_SalesInvoicePayment)) { }
        ...
        [ColumnInfo("@default", "int(1)", isNullable: false)]
        public bool Default
        {
            get { return ERPNextConverter.IntToBool((int)data.@default); }
            set { data.@default = ERPNextConverter.BoolToInt(value); }
        }
