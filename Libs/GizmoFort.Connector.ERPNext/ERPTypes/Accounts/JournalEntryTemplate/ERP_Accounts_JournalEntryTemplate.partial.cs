...
namespace GizmoFort.Connector.ERPNext.ERPTypes.Accounts.JournalEntryTemplate
{
    ...
    {
        public ERP_Accounts_JournalEntryTemplate() : this(new ERPObject(_DocType.Accounts_JournalEntryTemplate)) { }
        ...
        [ColumnInfo("template_title", "varchar(140)", isNullable: true)]
        public string? TemplateTitle
        {
            get { return data.template_title; }
            set { data.template_title = ERPNextConverter.TruncateString(value, 140); }
        }
