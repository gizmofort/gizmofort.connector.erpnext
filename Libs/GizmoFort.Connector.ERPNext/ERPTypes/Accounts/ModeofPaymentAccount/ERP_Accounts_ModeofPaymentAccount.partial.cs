...
namespace GizmoFort.Connector.ERPNext.ERPTypes.Accounts.ModeofPaymentAccount
{
    ...
    {
        public ERP_Accounts_ModeofPaymentAccount() : this(new ERPObject(_DocType.Accounts_ModeofPaymentAccount)) { }
        ...
        [ColumnInfo("default_account", "varchar(140)", isNullable: true)]
        public string? DefaultAccount
        {
            get { return data.default_account; }
            set { data.default_account = ERPNextConverter.TruncateString(value, 140); }
        }
