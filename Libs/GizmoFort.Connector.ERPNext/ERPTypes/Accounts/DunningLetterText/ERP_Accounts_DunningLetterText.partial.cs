...
namespace GizmoFort.Connector.ERPNext.ERPTypes.Accounts.DunningLetterText
{
    ...
    {
        public ERP_Accounts_DunningLetterText() : this(new ERPObject(_DocType.Accounts_DunningLetterText)) { }
        ...
        [ColumnInfo("is_default_language", "int(1)", isNullable: false)]
        public bool IsDefaultLanguage
        {
            get { return ERPNextConverter.IntToBool((int)data.is_default_language); }
            set { data.is_default_language = ERPNextConverter.BoolToInt(value); }
        }
