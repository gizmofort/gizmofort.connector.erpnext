...
namespace GizmoFort.Connector.ERPNext.ERPTypes.Accounts.ProcessStatementOfAccounts
{
    ...
    {
        public static ERP_Accounts_ProcessStatementOfAccounts CreateNew(string name /* add other parameters as needed */ )
        {
            ERP_Accounts_ProcessStatementOfAccounts obj = new()
            {
                Name = name
