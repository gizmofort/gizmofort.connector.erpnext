...
namespace GizmoFort.Connector.ERPNext.ERPTypes.Accounts.AccountingPeriod
{
    ...
    {
        public ERP_Accounts_AccountingPeriod() : this(new ERPObject(_DocType.Accounts_AccountingPeriod)) { }
        ...
        [ColumnInfo("period_name", "varchar(140)", isNullable: true)]
        public string? PeriodName
        {
            get { return data.period_name; }
            set { data.period_name = ERPNextConverter.TruncateString(value, 140); }
        }
