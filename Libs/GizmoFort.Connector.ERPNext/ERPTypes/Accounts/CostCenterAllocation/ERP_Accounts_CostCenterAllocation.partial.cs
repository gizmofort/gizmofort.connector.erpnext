...
namespace GizmoFort.Connector.ERPNext.ERPTypes.Accounts.CostCenterAllocation
{
    ...
    {
        public ERP_Accounts_CostCenterAllocation() : this(new ERPObject(_DocType.Accounts_CostCenterAllocation)) { }
        ...
        [ColumnInfo("main_cost_center", "varchar(140)", isNullable: true)]
        public string? MainCostCenter
        {
            get { return data.main_cost_center; }
            set { data.main_cost_center = ERPNextConverter.TruncateString(value, 140); }
        }
