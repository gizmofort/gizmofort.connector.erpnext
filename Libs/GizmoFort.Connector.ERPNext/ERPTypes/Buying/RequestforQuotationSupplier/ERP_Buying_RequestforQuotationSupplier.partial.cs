...
namespace GizmoFort.Connector.ERPNext.ERPTypes.Buying.RequestforQuotationSupplier
{
    ...
    {
        public ERP_Buying_RequestforQuotationSupplier() : this(new ERPObject(_DocType.Buying_RequestforQuotationSupplier)) { }
        ...
        [ColumnInfo("quote_status", "varchar(140)", isNullable: true)]
        public string? QuoteStatus
        {
            get { return data.quote_status; }
            set { data.quote_status = ERPNextConverter.TruncateString(value, 140); }
        }
        ...
        [ColumnInfo("send_email", "int(1)", isNullable: false)]
        public bool SendEmail
        {
            get { return ERPNextConverter.IntToBool((int)data.send_email); }
            set { data.send_email = ERPNextConverter.BoolToInt(value); }
        }
