...
namespace GizmoFort.Connector.ERPNext.ERPTypes.Buying.SupplierQuotation
{
    ...
    {
        public ERP_Buying_SupplierQuotation() : this(new ERPObject(_DocType.Buying_SupplierQuotation)) { }
        ...
        [ColumnInfo("quotation_number", "varchar(140)", isNullable: true)]
        public string? QuotationNumber
        {
            get { return data.quotation_number; }
            set { data.quotation_number = ERPNextConverter.TruncateString(value, 140); }
        }
