...
namespace GizmoFort.Connector.ERPNext.ERPTypes.Email.IMAPFolder
{
    ...
    {
        public ERP_Email_IMAPFolder() : this(new ERPObject(_DocType.Email_IMAPFolder)) { }
        ...
        [ColumnInfo("folder_name", "varchar(140)", isNullable: true)]
        public string? FolderName
        {
            get { return data.folder_name; }
            set { data.folder_name = ERPNextConverter.TruncateString(value, 140); }
        }
        ...
        [ColumnInfo("uidnext", "varchar(140)", isNullable: true)]
        public string? Uidnext
        {
            get { return data.uidnext; }
            set { data.uidnext = ERPNextConverter.TruncateString(value, 140); }
        }
