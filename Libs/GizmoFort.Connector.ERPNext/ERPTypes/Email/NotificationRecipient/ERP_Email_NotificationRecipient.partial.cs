...
namespace GizmoFort.Connector.ERPNext.ERPTypes.Email.NotificationRecipient
{
    ...
    {
        public ERP_Email_NotificationRecipient() : this(new ERPObject(_DocType.Email_NotificationRecipient)) { }
        ...
        [ColumnInfo("receiver_by_document_field", "varchar(140)", isNullable: true)]
        public string? ReceiverByDocumentField
        {
            get { return data.receiver_by_document_field; }
            set { data.receiver_by_document_field = ERPNextConverter.TruncateString(value, 140); }
        }

        [ColumnInfo("receiver_by_role", "varchar(140)", isNullable: true)]
        public string? ReceiverByRole
        {
            get { return data.receiver_by_role; }
            set { data.receiver_by_role = ERPNextConverter.TruncateString(value, 140); }
        }
        ...
        [ColumnInfo("condition", "varchar(140)", isNullable: true)]
        public string? Condition
        {
            get { return data.condition; }
            set { data.condition = ERPNextConverter.TruncateString(value, 140); }
        }
