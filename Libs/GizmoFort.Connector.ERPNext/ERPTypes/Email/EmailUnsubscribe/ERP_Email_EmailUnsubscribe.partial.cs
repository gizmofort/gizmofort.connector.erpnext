...
namespace GizmoFort.Connector.ERPNext.ERPTypes.Email.EmailUnsubscribe
{
    ...
    {
        public ERP_Email_EmailUnsubscribe() : this(new ERPObject(_DocType.Email_EmailUnsubscribe)) { }
        ...
        [ColumnInfo("global_unsubscribe", "int(1)", isNullable: false)]
        public bool GlobalUnsubscribe
        {
            get { return ERPNextConverter.IntToBool((int)data.global_unsubscribe); }
            set { data.global_unsubscribe = ERPNextConverter.BoolToInt(value); }
        }
