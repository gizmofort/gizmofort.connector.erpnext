...
namespace GizmoFort.Connector.ERPNext.ERPTypes.Stock.QualityInspectionParameterGroup
{
    ...
    {
        public ERP_Stock_QualityInspectionParameterGroup() : this(new ERPObject(_DocType.Stock_QualityInspectionParameterGroup)) { }
        ...
        [ColumnInfo("group_name", "varchar(140)", isNullable: true)]
        public string? GroupName
        {
            get { return data.group_name; }
            set { data.group_name = ERPNextConverter.TruncateString(value, 140); }
        }
