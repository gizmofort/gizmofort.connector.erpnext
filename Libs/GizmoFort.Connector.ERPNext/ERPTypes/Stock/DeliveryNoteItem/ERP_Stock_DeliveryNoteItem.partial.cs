...
namespace GizmoFort.Connector.ERPNext.ERPTypes.Stock.DeliveryNoteItem
{
    ...
    {
        public ERP_Stock_DeliveryNoteItem() : this(new ERPObject(_DocType.Stock_DeliveryNoteItem)) { }
        ...
        [ColumnInfo("against_sales_order", "varchar(140)", isNullable: true)]
        public string? AgainstSalesOrder
        {
            get { return data.against_sales_order; }
            set { data.against_sales_order = ERPNextConverter.TruncateString(value, 140); }
        }
        ...
        [ColumnInfo("against_sales_invoice", "varchar(140)", isNullable: true)]
        public string? AgainstSalesInvoice
        {
            get { return data.against_sales_invoice; }
            set { data.against_sales_invoice = ERPNextConverter.TruncateString(value, 140); }
        }

        [ColumnInfo("si_detail", "varchar(140)", isNullable: true)]
        public string? SiDetail
        {
            get { return data.si_detail; }
            set { data.si_detail = ERPNextConverter.TruncateString(value, 140); }
        }
        ...
        [ColumnInfo("pick_list_item", "varchar(140)", isNullable: true)]
        public string? PickListItem
        {
            get { return data.pick_list_item; }
            set { data.pick_list_item = ERPNextConverter.TruncateString(value, 140); }
        }
        ...
        [ColumnInfo("installed_qty", "decimal(21,9)", isNullable: false)]
