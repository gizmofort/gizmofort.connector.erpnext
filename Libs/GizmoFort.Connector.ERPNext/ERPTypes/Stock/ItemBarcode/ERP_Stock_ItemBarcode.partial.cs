...
namespace GizmoFort.Connector.ERPNext.ERPTypes.Stock.ItemBarcode
{
    ...
    {
        public ERP_Stock_ItemBarcode() : this(new ERPObject(_DocType.Stock_ItemBarcode)) { }
        ...
        [ColumnInfo("barcode_type", "varchar(140)", isNullable: true)]
        public string? BarcodeType
        {
            get { return data.barcode_type; }
            set { data.barcode_type = ERPNextConverter.TruncateString(value, 140); }
        }
