...
namespace GizmoFort.Connector.ERPNext.ERPTypes.Stock.ItemReorder
{
    ...
    {
        public ERP_Stock_ItemReorder() : this(new ERPObject(_DocType.Stock_ItemReorder)) { }
        ...
        [ColumnInfo("warehouse_group", "varchar(140)", isNullable: true)]
        public string? WarehouseGroup
        {
            get { return data.warehouse_group; }
            set { data.warehouse_group = ERPNextConverter.TruncateString(value, 140); }
        }
        ...
        [ColumnInfo("warehouse_reorder_level", "decimal(21,9)", isNullable: false)]
        ...
        [ColumnInfo("warehouse_reorder_qty", "decimal(21,9)", isNullable: false)]
