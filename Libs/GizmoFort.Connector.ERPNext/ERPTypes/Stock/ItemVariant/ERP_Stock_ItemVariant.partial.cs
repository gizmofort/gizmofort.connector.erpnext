...
namespace GizmoFort.Connector.ERPNext.ERPTypes.Stock.ItemVariant
{
    ...
    {
        public ERP_Stock_ItemVariant() : this(new ERPObject(_DocType.Stock_ItemVariant)) { }
        ...
        [ColumnInfo("item_attribute", "varchar(140)", isNullable: true)]
        public string? ItemAttribute
        {
            get { return data.item_attribute; }
            set { data.item_attribute = ERPNextConverter.TruncateString(value, 140); }
        }

        [ColumnInfo("item_attribute_value", "varchar(140)", isNullable: true)]
        public string? ItemAttributeValue
        {
            get { return data.item_attribute_value; }
            set { data.item_attribute_value = ERPNextConverter.TruncateString(value, 140); }
        }
