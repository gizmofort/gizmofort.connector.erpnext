...
namespace GizmoFort.Connector.ERPNext.ERPTypes.Stock.ItemQualityInspectionParameter
{
    ...
    {
        public static ERP_Stock_ItemQualityInspectionParameter CreateNew(string name /* add other parameters as needed */ )
        {
            ERP_Stock_ItemQualityInspectionParameter obj = new()
            {
                Name = name
