...
namespace GizmoFort.Connector.ERPNext.ERPTypes.CRM.Prospect
{
    ...
    {
        public ERP_CRM_Prospect() : this(new ERPObject(_DocType.CRM_Prospect)) { }
        ...
        [ColumnInfo("prospect_owner", "varchar(140)", isNullable: true)]
        public string? ProspectOwner
        {
            get { return data.prospect_owner; }
            set { data.prospect_owner = ERPNextConverter.TruncateString(value, 140); }
        }
