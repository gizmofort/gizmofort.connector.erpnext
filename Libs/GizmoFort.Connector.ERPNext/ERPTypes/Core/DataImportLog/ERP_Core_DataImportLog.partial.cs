...
namespace GizmoFort.Connector.ERPNext.ERPTypes.Core.DataImportLog
{
    ...
    {
        public ERP_Core_DataImportLog() : this(new ERPObject(_DocType.Core_DataImportLog)) { }
        ...
        [ColumnInfo("data_import", "varchar(140)", isNullable: true)]
        public string? DataImport
        {
            get { return data.data_import; }
            set { data.data_import = ERPNextConverter.TruncateString(value, 140); }
        }

        [ColumnInfo("row_indexes", "longtext", isNullable: true)]
        ...
        [ColumnInfo("success", "int(1)", isNullable: false)]
        public bool Success
        {
            get { return ERPNextConverter.IntToBool((int)data.success); }
            set { data.success = ERPNextConverter.BoolToInt(value); }
        }
        ...
        [ColumnInfo("messages", "longtext", isNullable: true)]
        ...
        [ColumnInfo("exception", "text", isNullable: true)]
        ...
        [ColumnInfo("log_index", "int(11)", isNullable: false)]
        public int LogIndex
        {
