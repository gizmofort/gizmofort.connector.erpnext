...
namespace GizmoFort.Connector.ERPNext.ERPTypes.Core.ReportFilter
{
    ...
    {
        public ERP_Core_ReportFilter() : this(new ERPObject(_DocType.Core_ReportFilter)) { }
        ...
        [ColumnInfo("mandatory", "int(1)", isNullable: false)]
        public bool Mandatory
        {
            get { return ERPNextConverter.IntToBool((int)data.mandatory); }
            set { data.mandatory = ERPNextConverter.BoolToInt(value); }
        }
        ...
        [ColumnInfo("wildcard_filter", "int(1)", isNullable: false)]
        public bool WildcardFilter
        {
            get { return ERPNextConverter.IntToBool((int)data.wildcard_filter); }
            set { data.wildcard_filter = ERPNextConverter.BoolToInt(value); }
        }
