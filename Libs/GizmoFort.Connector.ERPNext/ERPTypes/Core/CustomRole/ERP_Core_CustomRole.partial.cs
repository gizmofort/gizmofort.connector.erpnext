...
namespace GizmoFort.Connector.ERPNext.ERPTypes.Core.CustomRole
{
    ...
    {
        public ERP_Core_CustomRole() : this(new ERPObject(_DocType.Core_CustomRole)) { }
        ...
        [ColumnInfo("page", "varchar(140)", isNullable: true)]
        public string? Page
        {
            get { return data.page; }
            set { data.page = ERPNextConverter.TruncateString(value, 140); }
        }
