...
namespace GizmoFort.Connector.ERPNext.ERPTypes.Core.UserPermission
{
    ...
    {
        public ERP_Core_UserPermission() : this(new ERPObject(_DocType.Core_UserPermission)) { }
        ...
        [ColumnInfo("allow", "varchar(140)", isNullable: true)]
        public string? Allow
        {
            get { return data.allow; }
            set { data.allow = ERPNextConverter.TruncateString(value, 140); }
        }

        [ColumnInfo("for_value", "varchar(140)", isNullable: true)]
        public string? ForValue
        {
            get { return data.for_value; }
            set { data.for_value = ERPNextConverter.TruncateString(value, 140); }
        }
        ...
        [ColumnInfo("hide_descendants", "int(1)", isNullable: false)]
        public bool HideDescendants
        {
            get { return ERPNextConverter.IntToBool((int)data.hide_descendants); }
            set { data.hide_descendants = ERPNextConverter.BoolToInt(value); }
        }
