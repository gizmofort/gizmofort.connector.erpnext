...
namespace GizmoFort.Connector.ERPNext.ERPTypes.Core.CommunicationLink
{
    ...
    {
        public ERP_Core_CommunicationLink() : this(new ERPObject(_DocType.Core_CommunicationLink)) { }
        ...
        [ColumnInfo("link_title", "varchar(140)", isNullable: true)]
        public string? LinkTitle
        {
            get { return data.link_title; }
            set { data.link_title = ERPNextConverter.TruncateString(value, 140); }
        }
