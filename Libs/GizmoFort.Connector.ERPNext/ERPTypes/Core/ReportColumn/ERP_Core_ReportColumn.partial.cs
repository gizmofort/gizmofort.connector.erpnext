...
namespace GizmoFort.Connector.ERPNext.ERPTypes.Core.ReportColumn
{
    ...
    {
        public ERP_Core_ReportColumn() : this(new ERPObject(_DocType.Core_ReportColumn)) { }
        ...
        [ColumnInfo("options", "varchar(140)", isNullable: true)]
        public string? Options
        {
            get { return data.options; }
            set { data.options = ERPNextConverter.TruncateString(value, 140); }
        }
