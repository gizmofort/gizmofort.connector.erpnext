...
namespace GizmoFort.Connector.ERPNext.ERPTypes.Core.ViewLog
{
    ...
    {
        public ERP_Core_ViewLog() : this(new ERPObject(_DocType.Core_ViewLog)) { }
        ...
        [ColumnInfo("viewed_by", "varchar(140)", isNullable: true)]
        public string? ViewedBy
        {
            get { return data.viewed_by; }
            set { data.viewed_by = ERPNextConverter.TruncateString(value, 140); }
        }
