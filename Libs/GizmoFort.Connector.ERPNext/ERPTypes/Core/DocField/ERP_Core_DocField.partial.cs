...
namespace GizmoFort.Connector.ERPNext.ERPTypes.Core.DocField
{
    ...
    {
        public ERP_Core_DocField() : this(new ERPObject(_DocType.Core_DocField)) { }
        ...
        [ColumnInfo("oldfieldname", "varchar(140)", isNullable: true)]
        public string? Oldfieldname
        {
            get { return data.oldfieldname; }
            set { data.oldfieldname = ERPNextConverter.TruncateString(value, 140); }
        }
        ...
        [ColumnInfo("oldfieldtype", "varchar(140)", isNullable: true)]
        public string? Oldfieldtype
        {
            get { return data.oldfieldtype; }
            set { data.oldfieldtype = ERPNextConverter.TruncateString(value, 140); }
        }
        ...
        [ColumnInfo("set_only_once", "int(1)", isNullable: false)]
        public bool SetOnlyOnce
        {
            get { return ERPNextConverter.IntToBool((int)data.set_only_once); }
            set { data.set_only_once = ERPNextConverter.BoolToInt(value); }
        }
        ...
        [ColumnInfo("trigger", "varchar(255)", isNullable: true)]
        public string? Trigger
        {
            get { return data.trigger; }
            set { data.trigger = ERPNextConverter.TruncateString(value, 255); }
        }
        ...
        [ColumnInfo("width", "varchar(10)", isNullable: true)]
        public string? Width
        {
            get { return data.width; }
            set { data.width = ERPNextConverter.TruncateString(value, 10); }
        }

        [ColumnInfo("print_width", "varchar(10)", isNullable: true)]
        public string? PrintWidth
        {
            get { return data.print_width; }
            set { data.print_width = ERPNextConverter.TruncateString(value, 10); }
        }
        ...
        [ColumnInfo("max_height", "varchar(10)", isNullable: true)]
        public string? MaxHeight
        {
            get { return data.max_height; }
            set { data.max_height = ERPNextConverter.TruncateString(value, 10); }
        }
