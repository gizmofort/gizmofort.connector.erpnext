...
namespace GizmoFort.Connector.ERPNext.ERPTypes.Communication.CommunicationMediumTimeslot
{
    ...
    {
        public static ERP_Communication_CommunicationMediumTimeslot CreateNew(string name /* add other parameters as needed */ )
        {
            ERP_Communication_CommunicationMediumTimeslot obj = new()
            {
                Name = name
